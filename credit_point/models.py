...
class CreditPoint(models.Model):
    ...
    # order_payment = models.OneToOneField(Payment, on_delete=models.SET_NULL, null=True, blank=True, related_name='credit_point_order_payment')
    # credit_points_earned = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
