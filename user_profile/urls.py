...
urlpatterns = [
    ...
    path('google-login/', views.LoginWithGoogleView.as_view(), name='google-login'),
    # path('google-login/', views.LoginWithGoogleView.as_view(adapter_class=GoogleOAuth2Adapter), name='google-login'),
